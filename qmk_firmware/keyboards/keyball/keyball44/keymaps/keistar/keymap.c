...
//    |------------+------------+------------+------------+------------+------------|=======|    |=======|------------+------------+------------+------------+------------+------------|
                    KC_LALT , KC_LGUI , LCTL_T(KC_LNG2) , LT(1,KC_SPC)    , LT(3,KC_LNG1)   ,      KC_BSPC         , LT(2,KC_ENT)    , _______         , _______ , _______
//                |---------+---------+-----------------+-----------------+-----------------|    |-----------------+-----------------+-----------------+---------+---------|
...
[1] = LAYOUT_universal(
//    .-----------------------------------------------------------------------------.                    .-----------------------------------------------------------------------------.
        _______    , _______    , KC_7       , KC_8       , KC_9       , _______    ,                      _______    , S(KC_9)    , S(KC_0)    , KC_LBRC    , KC_RBRC    , _______    ,
//    |------------+------------+------------+------------+------------+------------|                    |------------+------------+------------+------------+------------+------------|
